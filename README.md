...
- **Tools:** Git, GitHub, Vite, Figma, Hardhat, Ethers.js  
...
- End-to-end platform with MongoDB, React, and Node  
- Implemented caching to reduce API load by 60%  
- React Context + custom hooks for scalable state management  
- Optimized MongoDB schema for multi-vendor ordering

### 💸 [Ether-Wallet](https://ether-wallet-green.vercel.app/)  
A frontend wallet interface for Ethereum  
- React + Tailwind + Vite for performance and design  
- Ethers.js integration for Web3 wallet functionality  
...
- **Offline Functionality:** Users can access core features even without an internet connection by caching essential assets and data :contentReference[oaicite:1]{index=1}.
- **Enhanced Performance:** Intelligent caching strategies lead to faster load times and reduced network requests :contentReference[oaicite:2]{index=2}.
- **Background Sync & Push Notifications:** Maintain data synchronization and user engagement, even when the app isn't actively in use :contentReference[oaicite:3]{index=3}.
- **App Shell Architecture:** Separates the core UI from dynamic content, ensuring quick initial loads and seamless user experiences :contentReference[oaicite:4]{index=4}.
...
- Created learning material used by 700+ students  
- Guided 20+ student projects in web development
